...
export const projects: Project[] = [
  ...
  },
  {
    ...
    headline: "What Makes Conversational AI Worth Using?",
    subtitle:
      "How clarity and cultural relevance shaped an older adult’s experience with ChatGPT",
    oneLiner:
      "A qualitative study with one older adult exploring whether understanding ChatGPT’s responses was enough to create motivation, trust, and continued use.",
    ...
    cover: {
      src: "",
      alt: "What Makes Conversational AI Worth Using? — project cover",
      width: 1800,
      height: 1200,
    },
    gallery: [],
    metrics: [
      ...
      { label: "Research team", value: "2 UX Researchers" },
      { label: "Methods", value: "Interview · Observation · Usability testing" },
    ],
    contributions: [
      "Lead UX research",
      "Interview design",
    ...
    sections: [
      {
        ...
        heading: "The outcome",
        body: [
          "Our participant understood most of ChatGPT’s responses, but that did not give her a reason to return. The biggest barriers were not visual accessibility, as we initially expected. They were knowing what to ask, understanding what the system was doing, and seeing enough value to continue using it.",
        ],
      },
      {
        kind: "context",
        heading: "The study and participant",
        body: [
          "We wanted to understand how an older adult’s confidence and trust in ChatGPT might change through repeated use. Our participant was an 87-year-old woman with little technology experience. She usually uses Facebook and YouTube for recipes, social interactions, and general entertainment.",
          "I began with an interview, unguided exploration, guided tasks, and text and voice usability testing. The original study was supposed to run over two weeks, with the participant trying ChatGPT independently before our next session. I quickly learned that she had little interest in returning to it. Compared with familiar apps like Facebook and YouTube, ChatGPT required more concentration and depended on her to initiate every interaction. The burden was placed on her rather than acting as a tool to help her.",
          "Rather than asking her to use it longer than necessary, I changed the plan for our second session. I also refreshed her memory of how the voice assistant worked, since it was easier for her to use than typing on her device. I introduced prompts related to the Philippines, Bicol, Tagalog, and travel to see whether personal relevance and cultural identity affected her engagement.",
        ],
      },
      {
        kind: "custom",
        ...
        annotations: [
          {
            ...
            body: [
              "The participant understood most responses but frequently asked: “What do I do now?” She did not naturally treat an answer as the beginning of a conversation. Without a clear goal, ChatGPT’s open-ended interface created more work instead of feeling useful.",
              "Unlike apps like Facebook or YouTube, where content is always shown, ChatGPT functions with the user needing to take initiative to complete a task or find an answer. For someone who does not actively engage in these activities, it can be difficult to know how to start.",
              "Opportunity: Provide familiar starting points and suggested follow-up questions instead of relying on a blank chat.",
            ],
          },
          {
            heading: "Voice felt natural while remaining confusing",
            body: [
              "Voice required less effort than typing, but unclear system behavior created feedback loops. ChatGPT sometimes interpreted the participant reading its responses aloud as new input. At other times, both sides waited for the other to lead. The participant was often heard saying “ok” but not realizing they had to make the next move.",
              "During one of these loops, she laughed and said: “Haha, you’re funny.” Although the interaction sounded social, she had not fully understood what ChatGPT was asking. She also struggled to tell whether it was listening, thinking, speaking, or waiting. Despite a conversational tone, the interaction cues were still unclear to someone without experience with voice assistants.",
              "Opportunity: Make voice states clearer and help users recover when conversations stall.",
            ],
          },
          {
            heading: "Familiar language changed her trust",
            body: [
              "The participant did not believe ChatGPT could speak her native language, so she did not try until I demonstrated it with her. When ChatGPT began speaking Tagalog and discussing the Philippines, she became more conversational. She confirmed the correct information with “Yes!” and “That’s right!” and playfully responded: “You know better than me.”",
              "Familiar topics helped her compare ChatGPT’s answers with her own knowledge. Pronunciation and dialect mistakes also showed her its limitations; a few words were incorrectly pronounced. Despite this, it was not enough to frustrate the participant.",
              "Her trust was not automatic. When she noticed the warning that “ChatGPT can make mistakes,” she responded with a surprised “Oh mistakes.” It quickly became clear that she did not consider that information from ChatGPT could be incorrect. The warning made her more cautious without explaining how to check an answer.",
              "Opportunity: Make language capabilities visible and pair AI warnings with clear ways to verify information. Currently, it puts the burden on the user to fact-check rather than supplying links they can use to verify.",
            ],
          },
        ],
      },
      {
        ...
        body: ["Based on our findings, we proposed:"],
        bodyAfter: [
          "Interest-based onboarding and familiar starting prompts",
          "Visible examples of language and voice capabilities",
          "Suggested next steps after each response",
          "Clear listening, thinking, and speaking states",
          "Direct ways to verify important information",
        ],
        bodyAfterFormat: "list",
        bodyAfterIndex: 0,
      },
      {
        ...
        heading: "Reflection",
        body: [
          "We began by asking whether repeated exposure would make ChatGPT easier to use. Instead, we learned that usability did not matter if the participant saw no reason to engage.",
          "When she showed little interest in continuing, we adjusted our research instead of forcing the original plan. This taught me to treat unexpected behavior as a finding, not a failure.",
          "Because this study involved one participant, these findings are ideas to test, not conclusions about all older adults. Despite this, these results provide insight into some of the problems that can occur with voice interactions on ChatGPT.",
        ],
      },
    ],
    featured: true,

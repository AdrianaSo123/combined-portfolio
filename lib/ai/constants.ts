...
// the wire import from here. This module is dependency-light (no KB/intent
// table) so it is safe to import into client components.
...
// Single source for the client-side offline state (audit #4): shown when the
// chat request itself fails, reusing the same top destinations.
